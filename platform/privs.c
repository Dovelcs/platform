...
static pset_t *zcaps2sys (platform_capabilities_t *, int);
static void zprivs_caps_init (struct platform_privs_t *);
...
static pset_t *
zcaps2sys (platform_capabilities_t *zcaps, int num)
{
  pset_t *syscaps;
  int i, j = 0, count = 0;
...
static void
zprivs_caps_init (struct platform_privs_t *zprivs)
{
...
void
zprivs_init(struct platform_privs_t *zprivs)
{
...
void 
zprivs_terminate (struct platform_privs_t *zprivs)
{
  if (!zprivs)
    {
