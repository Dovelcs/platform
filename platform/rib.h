...
struct rib
{
  ...
  /* Flags of this route.
   * This flag's definition is in lib/platform.h ZEBRA_FLAG_* and is exposed
...
extern struct platform_vrf *zebra_vrf_lookup (vrf_id_t vrf_id);
extern struct platform_vrf *platform_vrf_alloc (vrf_id_t);
 ...
 * rib_dest_vrf
 */
static inline struct platform_vrf *
