...
struct platform_privs_t
{
  platform_capabilities_t *caps_p;       /* caps required for operation */
  platform_capabilities_t *caps_i;       /* caps to allow inheritance of */
...
extern void zprivs_init (struct platform_privs_t *zprivs);
  /* drop all and terminate privileges */ 
extern void zprivs_terminate (struct platform_privs_t *);
